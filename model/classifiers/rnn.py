...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # h0-(N,hidden_dim)   features-(N,D)    W_proj-(D,hidden_dim)  
        
        
        # Step (2)
        out_embed, cache_embed = word_embedding_forward(captions_in,W_embed)
        # out_embed -(N, T-1, wordvec_dim)    captions_in-(N,T-1)    W_embed(vocab_size, wordvec_dim) 
        ...
        # scores - (N, T, M)    cache_temproal_affine  = out_rnn, W_vocab  b_vocab , scores
    ...
    def sample(self, features, max_length=30):
        ...
        for t in range(max_length):
            ...
            if self.cell_type == 'rnn':
                ...
                h,cell, _ = lstm_step_forward(out_embed, h, cell, Wx, Wh, b)
